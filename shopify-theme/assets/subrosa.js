...
debugEl.style.cssText = 'display:none; position:fixed; bottom:70px; left:16px; z-index:200; font-family:monospace; font-size:0.7rem; color:var(--ss-neon); background:rgba(5,5,8,0.9); padding:6px 12px; border-radius:3px; pointer-events:none; border:1px solid rgba(var(--ss-neon-rgb),0.3);';
